 ...
 *
 * @!attribute preserveEndpointHostname
 *   @return [Boolean] whether to keep endpoint hostname
 *    as-is. Defaults to 'false', which moves dns-compatible bucket
 *    names from the uri path to the hostname as a sub-domain.
 *
